...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=Arquisoft_wiq_es05c1&metric=coverage)](https://sonarcloud.io/summary/new_code?id=Arquisoft_wiq_es05c1)
...
```sh
git clone https://github.com/Arquisoft/wiq_es05c1.git
```
...
deploy:
    ...
    - name: Deploy over SSH
      ...
      with:
        ...
        command: |
          wget https://raw.githubusercontent.com/arquisoft/wiq_es05c1/master/docker-compose.yml -O docker-compose.yml
          wget https://raw.githubusercontent.com/arquisoft/wiq_es05c1/master/.env -O .env
