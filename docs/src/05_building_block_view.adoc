...
==== <Name black box 1>User Interface
...
==== <Name black box 2>Business Logic
...
==== White Box _<building block 1>_ Components...
...
==== White Box _<building block 2>_ Services...
...
==== White Box _<building block m>_ Model...
