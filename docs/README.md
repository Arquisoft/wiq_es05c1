...
The deployment url is: [https://arquisoft.github.io/wiq_es05c1/](https://arquisoft.github.io/wiq_es05c1/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_es05c1/](https://arquisoft.github.io/wiq_es05c1/), we need to execute `npm run deploy`.
